...
assert HELLOSIGN_AUTHENTICATION is not None, 'You must define a settings.HELLOSIGN_AUTHENTICATION see: http://www.hellosign.com/api/reference#EventHashVerification'
